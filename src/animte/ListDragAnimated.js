...
const styles = StyleSheet.create({
  ...
  selected_item_icon: {
      ...
      position: 'absolute',
      top: -3, // 下移点
      left: childrenWidth - 16, // 右移点，也可以换个布局
  },
  unselected_item: {
      width: 72,
      height: 36,
...
export default class CommonSortPage extends Component {
    ...
    renderSelectedItemView = (item, index) => {
        const clearIcon = this.state.isEditState ? <Icon style={styles.selected_item_icon} name="ios-close" size={18} color="#ccc" /> : undefined;
        return (
