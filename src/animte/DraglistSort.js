...
import { FlatList, PanResponder, StyleSheet, findNodeHandle, UIManager, Animated, View, Image } from 'react-native';
...
class OrderFlatList extends React.Component {
   ...
   * @private
   */
  _getOrderButtonMarginRight = isOrder => isOrder ? 0 : -1 * this.props.orderWidth

  /**
   * 渲染子项
   */
  _renderItem = ({ item, index }) => {
    let { orderStyle } = this.props;
